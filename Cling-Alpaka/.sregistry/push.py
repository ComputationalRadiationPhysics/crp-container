...
def get_container_version():
    ...
    """
    c_version = 'singularity inspect -d cling-alpaka.sif'
    ...
    for line in output.decode("utf-8").split('\n'):
        if 'CLING ALPAKA VERSION' in line:
            # since the tag is generated, it should have same form every time
            # XCC Version x.x
            return line.strip()[len('CLING ALPAKA VERSION '):]
